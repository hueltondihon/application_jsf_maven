...
public class CPFValidator implements Validator{
    ...
    public void validate(FacesContext ctx, UIComponent cmpt, Object valor) throws ValidatorException {
        if(!validaCPF(String.valueOf(valor))){
           ...
           message.setDetail("CPF Incorreto!");
           message.setSummary("CPF Incorreto!");
    ...
    //remove pontos e tracos
        ...
        if(cpf == null || cpf.length() != 11 || isCPFPadrao(cpf))
            ...
            if(!calcDigVerifi(cpf.substring(0, 9)).equals(cpf.substring(9, 11))){
                return false;
            }
             return true;
        }
       ...
       private static String calcDigVerifi(String num) {
